...
class Object
{
    ...
    static public function load($name){
        ...
        $class_full_name= BS.$module_root_name.BS.$current_module_name.BS.self::$type.BS.self::$file_name;
        self::$module_name = $current_module_name;
        self::$type_path=\Loader::$namespaces[$module_root_name].DS.$current_module_name.DS.self::$type.DS;
