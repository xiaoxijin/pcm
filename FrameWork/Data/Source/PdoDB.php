 ...
 *
 */
class PdoDB extends \PDO implements \Xphp\IFace\Database
{
	public $debug = false;
    protected $config;
    ...
    public final function query($sql)
    {
        ...
        $res = parent::query($sql) or \Xphp\Exception\Error::info(
            "SQL Error",
    ...
    public final function queryLine($sql, $_)
    {
        ...
        {
            \Xphp\Exception\Error::info("SQL Error", implode(", ", $this->errorInfo()) . "<hr />$sql");
            return false;
        }
    }
